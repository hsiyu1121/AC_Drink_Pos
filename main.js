...
const checkButton = document.querySelector('[data-alpha-pos="checkout"]')
       ...
       <div class="card mb-3">
          <div class="card-body">
            <div class="text-right">
              <span data-alapha-pos="delete-drink">x</span>
            </div>
...
orderLists.addEventListener('click', function (event) {
  let isDeleteButton = event.target.matches('[data-alapha-pos="delete-drink"]')
  if (!isDeleteButton) {
    return
  }
